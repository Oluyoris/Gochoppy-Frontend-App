...
export default function VendorWallet() {
        ...
        { text: 'Cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Success', 'Withdrawal request submitted! Pending approval.');
              setAmount('');
              setBankName('');
              setAccountNumber('');
              setAccountName('');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        {/* ── Hero Balance Card ─────────────────────────
            Large teal gradient card showing available
            balance prominently at the top
        ──────────────────────────────────────────────── */}
          ...
          <View style={styles.heroInner}>
            <View style={styles.heroLeft}>
              <View style={styles.heroBadge}>
                <Ionicons name="wallet-outline" size={13} color={TEAL_DARK} />
                <Text style={styles.heroBadgeText}>Available Balance</Text>
              </View>
              <Text style={styles.heroBalance}>
                ₦{Number(balance).toLocaleString()}
              </Text>
              <Text style={styles.heroNote}>Ready to withdraw</Text>
            </View>
        ...
        {/* ── Earnings Stat Card ────────────────────────
            Smaller orange card for total earnings
        ──────────────────────────────────────────────── */}
        <Animated.View style={{ opacity: fadeAnim }}>
          <View style={styles.earningsCard}>
            <View style={styles.earningsIconWrap}>
              <Ionicons name="trending-up-outline" size={22} color={ORANGE} />
            </View>
        ...
        <View style={styles.sectionDivider}>
          ...
          <View style={styles.sectionLabelWrap}>
            <Ionicons name="arrow-up-circle-outline" size={14} color={ORANGE} />
        ...
        {/* ── Withdrawal Form Card ──────────────────────
            Clean card with icon-prefixed inputs
        ──────────────────────────────────────────────── */}
...
const styles = StyleSheet.create({
  ...
  earningsValue: { fontSize: 22, fontWeight: '900', color: ORANGE, letterSpacing: -0.5 },
  earningsRight: {},
  ...
  sectionLabelWrap: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: ORANGE_SOFT, paddingHorizontal: 10, paddingVertical: 5,
    borderRadius: 20, borderWidth: 1, borderColor: ORANGE_MID,
  },
  sectionLabel: { fontSize: 11, fontWeight: '700', color: ORANGE },
  ...
  // Amount input — larger, special styling
  amountInputWrap: {
    borderColor: TEAL_BORDER, borderWidth: 1.5,
    backgroundColor: TEAL_BG,
  },
  currencyPrefix: {
    fontSize: 22, fontWeight: '800', color: TEAL_DARK,
  ...
  balanceHint: {
    fontSize: 12, color: TEXT_SOFT, fontWeight: '500',
  ...
  submitBtnText: {
    color: WHITE, fontSize: 15, fontWeight: '800', letterSpacing: 0.2,
  },
